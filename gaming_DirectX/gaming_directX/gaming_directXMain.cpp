#include "pch.h"
#include "gaming_DirectXMain.h"
#include "Common\DirectXHelper.h"

using namespace gaming_DirectX;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// 애플리케이션이 로드되면 애플리케이션 자산을 로드하고 초기화합니다.
gaming_DirectXMain::gaming_DirectXMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
gaming_DirectXMain::~gaming_DirectXMain()
{
	// 디바이스 알림 등록 취소
...
void gaming_DirectXMain::CreateWindowSizeDependentResources() 
{
...
void gaming_DirectXMain::Update() 
{
	// 장면 개체를 업데이트합니다.
	m_timer.Tick([&]()
	{
...
bool gaming_DirectXMain::Render() 
{
...
void gaming_DirectXMain::OnDeviceLost()
{
...
void gaming_DirectXMain::OnDeviceRestored()
{
